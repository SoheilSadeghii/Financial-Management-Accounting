        ...
        private void btnDeleteCustomer_Click(object sender, EventArgs e)
        {
            if (dgvCustomers.CurrentRow != null)
            {
                using (UnitOfWork db = new UnitOfWork())
                {
                    ...
                    if (MessageBox.Show($"Are you sure you want to delete {name}?", "Attention", MessageBoxButtons.YesNo,
            ...
            {
                MessageBox.Show("Please select a customer!", "Attention", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
